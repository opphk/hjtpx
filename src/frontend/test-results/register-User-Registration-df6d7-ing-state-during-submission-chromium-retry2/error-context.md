...
- Name: register.spec.js >> User Registration Flow >> UI Elements >> should show loading state during submission
- Location: tests/e2e/register.spec.js:178:5
...
Call log:
  ...
  - waiting for locator('button[type="submit"]')
    14 × locator resolved to <button type="submit" aria-busy="false" aria-disabled="false" class="btn btn-primary btn-medium auth-submit">注册</button>
