...
- Name: user-management.spec.js >> User Management >> User Search >> should display search input field
- Location: tests/e2e/user-management.spec.js:80:5
...
Locator: locator('input[placeholder*="搜索"], input[placeholder*="search"], input[type="search"]').first()
Expected: visible
Timeout: 5000ms
