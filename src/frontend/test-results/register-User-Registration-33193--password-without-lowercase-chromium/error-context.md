...
- Name: register.spec.js >> User Registration Flow >> Form Validation >> should show validation error for password without lowercase
- Location: tests/e2e/register.spec.js:118:5
...
Expected pattern: /密码|小写|lowercase/i
Received string:  ""
Timeout: 5000ms
