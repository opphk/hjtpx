...
- Name: register.spec.js >> User Registration Flow >> Form Validation >> should show validation error for empty name field
- Location: tests/e2e/register.spec.js:45:5
