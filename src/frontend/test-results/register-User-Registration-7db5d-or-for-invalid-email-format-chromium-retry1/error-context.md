...
- Name: register.spec.js >> User Registration Flow >> Form Validation >> should show validation error for invalid email format
- Location: tests/e2e/register.spec.js:76:5
