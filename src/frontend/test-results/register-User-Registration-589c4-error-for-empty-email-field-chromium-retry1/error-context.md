...
- Name: register.spec.js >> User Registration Flow >> Form Validation >> should show validation error for empty email field
- Location: tests/e2e/register.spec.js:66:5
