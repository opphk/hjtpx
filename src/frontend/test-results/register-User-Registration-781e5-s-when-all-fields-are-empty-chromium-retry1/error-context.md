...
- Name: register.spec.js >> User Registration Flow >> Form Validation >> should show multiple validation errors when all fields are empty
- Location: tests/e2e/register.spec.js:151:5
