...
- Name: register.spec.js >> User Registration Flow >> Form Validation >> should show validation error for empty password field
- Location: tests/e2e/register.spec.js:87:5
