...
- Name: login.spec.js >> User Login Flow >> UI Elements >> should show loading state during submission
- Location: tests/e2e/login.spec.js:113:5
...
Call log:
  ...
  - waiting for locator('button[type="submit"]')
    14 × locator resolved to <button type="submit" aria-busy="false" aria-disabled="false" class="btn btn-primary btn-medium auth-submit">登录</button>
