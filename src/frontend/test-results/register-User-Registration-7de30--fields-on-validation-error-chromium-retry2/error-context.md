...
- Name: register.spec.js >> User Registration Flow >> Form Data Preservation >> should clear password fields on validation error
- Location: tests/e2e/register.spec.js:249:5
  ...
  - generic [ref=e8]:
    ...
    - generic [ref=e15]:
      ...
      - textbox "密码*" [ref=e17]:
        - /placeholder: 请输入密码
        - text: short
      - alert [ref=e18]: 密码至少8个字符
    - generic [ref=e19]:
      - generic [ref=e20]: 确认密码*
      - textbox "确认密码*" [ref=e21]:
        - /placeholder: 请再次输入密码
        - text: short
    - button "注册" [active] [ref=e22] [cursor=pointer]
  - paragraph [ref=e24]:
    - text: Already have an account?
    - link "Sign In Now" [ref=e25] [cursor=pointer]:
      - /url: /login
```
