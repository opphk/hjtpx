...
- Name: login.spec.js >> User Login Flow >> UI Elements >> should have correct input types for accessibility
- Location: tests/e2e/login.spec.js:108:5
...
Call log:
  ...
  - waiting for locator('input[name="email"]')
    14 × locator resolved to <input value="" id="email" type="text" required="" name="email" class="form-input" placeholder="请输入邮箱" aria-invalid="false" aria-required="true" aria-disabled="false"/>
