class EnvironmentDetectorEnhanced {
    ...
    getDetectionMethods() {
        return [
            ...
            { name: 'detectEmulators', category: 'emulator' },
            { name: 'detectCloudPhones', category: 'emulator' },
            { name: 'detectVirtualMachines', category: 'virtualization' },
            { name: 'detectContainers', category: 'container' },
    ...
    async detectCloudPhones() {
        ...
        try {
            ...
            score += 15;
            detections.push('cloud_phone_detection_error: ' + e.message);
        }
        return { detected: score > 35, score: Math.min(score, 100), detections };
    }
    ...
    async detectVirtualMachines() {
        ...
        try {
            ...
            score += 20;
            detections.push('vm_detection_error: ' + e.message);
        }
        return { detected: score > 30, score: Math.min(score, 100), detections };
    }
