-- Migration: Create Presence (Online Status) Table
-- Created: 2026-05-14
-- Description: Creates presence table for tracking real-time user online status and WebSocket connections
...
-- Create trigger for presence table
...
VALUES ('006_create_presence', CURRENT_TIMESTAMP)
