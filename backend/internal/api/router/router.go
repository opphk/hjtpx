...
func setupAdminRoutes(r *gin.Engine, cacheHandler *handler.CacheMetricsHandler, dbHandler *handler.DatabaseMetricsHandler) {
	...
	adminRouter.GET("/api/logs/export/stream", handler.StreamExportLogs)
	...
	adminRouter.GET("/api/logs/analytics", handler.GetLogAnalytics)
	adminRouter.POST("/api/logs/analytics", handler.GetLogAnalytics)
	adminRouter.POST("/api/logs/search", handler.AdvancedSearchLogs)
	adminRouter.POST("/api/logs/saved-searches", handler.SaveLogSearch)
