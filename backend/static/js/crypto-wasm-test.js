...
(function() {
    ...
    console.log('\n6. ChaCha20-Poly1305 加密测试:');
    console.log('   (async () => {');
    console.log('       await CryptoWasm.initialize();');
    console.log('       ');
    console.log('       const plaintext = "Hello, ChaCha20-Poly1305!";');
    console.log('       const password = "test-chacha20-password";');
    console.log('       ');
    console.log('       // 加密');
    console.log('       const encrypted = await CryptoWasm.encryptChaCha20(plaintext, password);');
    console.log('       console.log("ChaCha20 Encrypted:", encrypted);');
    console.log('       console.log("Algorithm:", encrypted.algorithm);');
    console.log('       ');
    console.log('       // 解密');
    console.log('       const decrypted = await CryptoWasm.decryptChaCha20(encrypted, password, { salt: encrypted.salt });');
    console.log('       console.log("ChaCha20 Decrypted:", decrypted);');
    console.log('       console.log("Match:", decrypted === plaintext);');
    console.log('   })();');

    console.log('\n7. ChaCha20-Poly1305 二进制密钥测试:');
    console.log('   (async () => {');
    console.log('       await CryptoWasm.initialize();');
    console.log('       ');
    console.log('       const plaintext = "Test with binary key";');
    console.log('       const key = CryptoWasm.generateRandomBytes(32); // 256-bit key');
    console.log('       ');
    console.log('       // 加密');
    console.log('       const encrypted = await CryptoWasm.encryptChaCha20(plaintext, key);');
    console.log('       console.log("Binary Key Encrypted:", encrypted);');
    console.log('       ');
    console.log('       // 解密');
    console.log('       const decrypted = await CryptoWasm.decryptChaCha20(encrypted, key);');
    console.log('       console.log("Binary Key Decrypted:", decrypted);');
    console.log('       console.log("Match:", decrypted === plaintext);');
    console.log('   })();');

    console.log('\n8. ChaCha20-Poly1305 附加认证数据(AAD)测试:');
    console.log('   (async () => {');
    console.log('       await CryptoWasm.initialize();');
    console.log('       ');
    console.log('       const plaintext = "Data with AAD";');
    console.log('       const password = "aad-test-password";');
    console.log('       const aad = new TextEncoder().encode("Additional authenticated data");');
    console.log('       ');
    console.log('       // 使用AAD加密');
    console.log('       const encrypted = await CryptoWasm.encryptChaCha20(plaintext, password, { additionalData: aad });');
    console.log('       console.log("AAD Encrypted:", encrypted);');
    console.log('       ');
    console.log('       // 使用相同AAD解密');
    console.log('       const decrypted = await CryptoWasm.decryptChaCha20(encrypted, password, { salt: encrypted.salt, additionalData: aad });');
    console.log('       console.log("AAD Decrypted:", decrypted);');
    console.log('   })();');

    console.log('\n9. ChaCha20-Poly1305 完整性验证测试:');
    console.log('   (async () => {');
    console.log('       await CryptoWasm.initialize();');
    console.log('       ');
    console.log('       const plaintext = "Test integrity";');
    console.log('       const password = "integrity-test";');
    console.log('       ');
    console.log('       const encrypted = await CryptoWasm.encryptChaCha20(plaintext, password);');
    console.log('       ');
    console.log('       // 尝试篡改密文');
    console.log('       const tampered = { ...encrypted };');
    console.log('       tampered.ciphertext = tampered.ciphertext.slice(0, -1) + "X";');
    console.log('       ');
    console.log('       try {');
    console.log('           const decrypted = await CryptoWasm.decryptChaCha20(tampered, password, { salt: encrypted.salt });');
    console.log('           console.log("Tampering detection FAILED");');
    console.log('       } catch (e) {');
    console.log('           console.log("Tampering detected:", e.message);');
    console.log('           console.log("Integrity verification SUCCESS");');
    console.log('       }');
    console.log('   })();');
